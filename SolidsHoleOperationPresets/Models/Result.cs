...
namespace SHOP.Models
{
    ...
    public class Result
    {
        ...
        /// <summary> Gets a value indicating whether true if this object is failure. </summary>
    ...
    public class Result<T> : Result
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Result{T}"/> class. Initializes a new instance of the MDFDoors.Models.Result&lt;T&gt; class. </summary>
        ///
        /// <param name="value">     The value. </param>
        /// <param name="isSuccess"> True if this object is success. </param>
        /// <param name="error">     The error. </param>
